...
public class JwtTokenUtil implements Serializable {
	...
	public JwtUser getUserDetails(String token) {
		...
		try {
			...
			return new JwtUser(
					...
					(boolean) claims.get(CLAIM_KEY_IS_ENABLED));	//se presente o meno in black list
    ...
    private Boolean ignoreTokenExpiration(String token) {
        ...
        return (AUDIENCE_UNKNOWN.equals(audience) || AUDIENCE_WEB.equals(audience));
    }
	...
	public String generateToken(UserDetails userDetails, Device device) throws JsonProcessingException {
		...
		//preparo la lista delle autorità dell'utente
